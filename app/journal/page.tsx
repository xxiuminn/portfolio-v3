  ...
  return (
    <div className="container">
      ...
      <section className="hero fade fade-2" style={{ paddingTop: 52 }}>
        <h1 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(26px, 5vw, 36px)", fontWeight: 500, letterSpacing: "-0.01em", lineHeight: 1.25 }}>
          Writing
        </h1>
        <p style={{ marginTop: 10, fontSize: 15, color: "var(--ink-2)", lineHeight: 1.6 }}>
          Thoughts on marketing, tech, and building things.
        </p>
      </section>

      <section className="reveal">
        <div className="blog-list" style={{ marginTop: 0, borderTop: "1px solid var(--rule)" }}>
          {posts.map((post) => (
